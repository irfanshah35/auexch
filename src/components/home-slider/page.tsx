...
// 👇 Wapas purani positions lagadi hain (Top-Left for dots)
...
export default function HomeSlider() {
  ...
  const displaySliders = staticSliders;
    ...
    <div className="w-full">
      {displaySliders.length > 0 && (
        <div className={sliderWrapperStyles}>
          ...
          {/* 👇 Dots wapas Top-Left par */}
          <div className="custom-pagination"></div>

          {/* 👇 Arrows wapas Top-Right par */}
          ...
          >
            {displaySliders.map((item, index) => (
              <SwiperSlide key={item.id || index}>
                {/* 👇 Height/Width properly responsive (AuExch jaisi) */}
